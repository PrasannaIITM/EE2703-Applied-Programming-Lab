...
def spectrum(lim,n,f,t_=0,show_ = True,t_lims = False,windowing= False,xlim1=10,title1 = r"Spectrum of $\sin\left(\sqrt{2}t\right)$",xlabel1 = r"$\omega$",ylabel1= r"$|Y|$", ylabel2 = r"Phase of $Y$"):
    if(t_lims):
        t = t_
    else:
...
#FFT of cos^3 
a,b = spectrum(4*pi,64*4,cos3,xlim1= 3,windowing=False, title1 = r"Spectrum of $cos^3(w_0t)$")
a,b = spectrum(4*pi,64*4,cos3,xlim1= 3,windowing=True, title1 = r"Spectrum of $cos^3(w_0t)$")


#FFT of cos(wt+delta) 
w,Y = spectrum(pi,128,cosine,xlim1= 3,windowing=True, title1 = r"Spectrum of $cos(w_0t + \delta)$")
